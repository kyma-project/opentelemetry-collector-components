// Dependency from: https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/internal/k8sleaderelectortest/fake_extension.go
// This file is part of the OpenTelemetry Collector Contrib project, and it was moved to their internal package in the past: https://github.com/open-telemetry/opentelemetry-collector-contrib/pull/44761 (v0.142.0+)
// Since that does not allow a direct import anymore, but we still rely on this fake for testing purposes, we copied it here as well.
